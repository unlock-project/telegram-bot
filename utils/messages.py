...
welcome_message = "Привет, <b>{name}</b>!\n" \
                  "На смене Unlock действует внутренняя валюта — биты (฿). В течение смены их можно зарабатывать, а в конце 15 человек, накопивших больше всего битов, получат крутые подарки. " \
                  "Этот бот позволит посмотреть свой баланс, отобразить события, а также участвовать в интерактивах.\n\n" \
                  "При посещении каждого мероприятия нужно показывать организатору личный QR-код. За это начисляются 5฿." \
                  " Если в командном мероприятии твоя команда займёт первое место, то всем её членам добавят 30฿, за второе — 20฿, а за третье — 10฿. На лекциях и мастер-классах самые активные участники будут получать 10฿." \
                  " Ещё иногда сюда будут присылаться челленджи (за них тоже будут начисляться биты)." \
                  "\n\nВсе биты, полученные членами команды, суммируются в командный рейтинг. Он тоже очень пригодится 😋"
...
not_met = "Мы ещё не познакомились. Напиши /start"
